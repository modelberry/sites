...
export const modelberryPluginData: ModelberryPluginData = {
  '@modelberry/plugin-contentful/plain': {
    validations: {
      ...
      'linkContentType-navigationSection-textSection': {
        linkContentType: ['navigationSection', 'textSection', 'topicSection'],
      },
      ...
      'in-activity-airplay-alert-circle': {
        in: [
          'activity',
          'airplay',
          'alert-circle',
      ...
      'linkContentType-action': { linkContentType: ['navigationAction'] },
      'linkContentType-navigationSegment': {
        linkContentType: ['navigationSegment'],
      },
      'in-activity-airplay-alert-circle-17': {
        in: [
          'activity',
          'airplay',
          'alert-circle',
